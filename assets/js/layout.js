...
(function ($) {
	...
	if ($("body").hasClass("tt-transition")) {
		...
		function LogoLoading(callback) {
			var $preloaderLogo = $('.preloader-logo svg')
			$preloaderLogo.animate({ 'opacity': 1 }, 2000, callback)
		}
		...
		// ================
		function HideLoad() {
			var $preloader = $('.preloader').fadeOut(1000)
			var tl_transitOut = gsap.timeline();
				 ...
				 if ($phAppear.length) {
				 	tl_transitOut.from($phAppear, { duration: 2, y: 40, autoAlpha: 0, stagger: 0.05, ease: Expo.easeOut, clearProps:"all" }, 1.5);
				 }
   ...
   // ============================================================================
	...
	$(".anim-fadein").each(function() {
		...
		tl_FadeIn.from(this, { duration: 2.5, autoAlpha: 0, ease: Expo.easeOut, clearProps:"all" }, "+=0.3");
	});
	...
	var $servicesGrid = $('.services-grid .item')
	$servicesGrid.on('mouseover', function() {
		$servicesGrid.removeClass('hover')
		$(this).addClass('hover')
	})
	$servicesGrid.on('mouseout', function() {
		$(this).removeClass('hover')
		if (!$servicesGrid.hasClass('hover')) {
			$(this).addClass('hover')
		}
	})
	

	// var action = gsap.set('.section-img-scroll .text-sticky', {
	// 	position:'fixed', 
	// 	color:'red', 
	// 	paused:true
	// });
	...
	// var sidebar = new StickySidebar('.text-sticky', {
	// 	topSpacing: 200,
	// 	bottomSpacing: 20,
	// 	containerSelector: '.section-img-scroll',
	// });
